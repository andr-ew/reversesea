...
rather than recording & storing events associated with the grid, the pattern recorder should record & store _data_ assoiated with the grid – i.e. the full list of which keys are held at any given time throuout the pattern.
